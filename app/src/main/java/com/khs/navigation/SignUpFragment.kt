...
import com.khs.navigation.databinding.FragmentSignUpBinding
...
class SignUpFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mBinding.btnNext.setOnClickListener {
            if(!TextUtils.isEmpty(mBinding.edtName.text)){
                val bundle = bundleOf("name" to mBinding.edtName.text.toString())
